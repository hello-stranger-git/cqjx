	...
	<article class="article_main">
		...
		<div class="xgzl">
			<div class="xgzl_title clearfix">
				...
				<a href="${pageContext.request.contextPath}/webNewsAction_findNews">
						...
						<div class="row">
						  <c:forEach items="${newsList }" var="newsList">
							  <div class="col-sm-6 col-md-3">
							    <div class="thumbnail">
							      <img src="${newsList.newsImage}" style="width:240px;height:200px">
							      <div class="caption">
							        <h3 style="height: 27px;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 1;overflow: hidden;">${newsList.newstype}</h3>
							        ...
							        <p style="text-align: center;"><a href="${pageContext.request.contextPath}/webNewsAction_findNewsMessage?uuid=${newsList.uuid}" class="btn btn-primary" role="button">查看详情</a> </p>
							      </div>
							    </div>
							   </div>
							</c:forEach>
